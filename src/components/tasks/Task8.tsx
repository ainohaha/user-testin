...
export function Task8({ onComplete, onPrevious, taskNumber, totalTasks, participantId, micStream, screenStream, isRecording, scenario, existingData }: Task8Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <RadioGroup value={completed} onValueChange={setCompleted}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="t8-yes" />
              <Label htmlFor="t8-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="t8-no" />
              <Label htmlFor="t8-no" className="flex-1">
                <span>No</span>
                {showTimeWarning && (
        ...
        <div className="space-y-3">
          <h3>How easy was it to check-in and send off your items? *</h3>
        ...
        <div className="space-y-3">
          <Label htmlFor="t8-improvements">
            What did you think about the check-in and item drop-off process? Any confusion or improvements? *
          </Label>
          <Textarea
            id="t8-improvements"
