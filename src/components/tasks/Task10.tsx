...
export function Task10({ onComplete, onPrevious, taskNumber, totalTasks, participantId, micStream, screenStream, isRecording, scenario, existingData }: Task10Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <RadioGroup value={completed} onValueChange={setCompleted}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="t10-yes" />
              <Label htmlFor="t10-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="t10-no" />
              <Label htmlFor="t10-no" className="flex-1">
                <span>No</span>
                {showTimeWarning && (
        ...
        <div className="space-y-3">
          <h3>How clear were the cashout and rewards redemption options? *</h3>
        ...
        <div className="space-y-3">
          <Label htmlFor="t10-feedback">
            What did you think about the cashout and rewards options? Any confusion or suggestions for improvement? *
          </Label>
          <Textarea
            id="t10-feedback"
