...
export function Task6({ onComplete, onPrevious, taskNumber, totalTasks, participantId, micStream, screenStream, isRecording, scenario, existingData }: Task6Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <RadioGroup value={completed} onValueChange={setCompleted}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="t6-yes" />
              <Label htmlFor="t6-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="t6-no" />
              <Label htmlFor="t6-no" className="flex-1">
                <span>No</span>
                {showTimeWarning && (
        ...
        <div className="space-y-3">
          <h3>How clear was the alert and order confirmation process? *</h3>
        ...
        <div className="space-y-3">
          <Label htmlFor="t6-insights">
            What did you think about reviewing the alert and confirming the order? Any confusion or improvements? *
          </Label>
          <Textarea
            id="t6-insights"
