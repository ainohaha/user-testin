...
export function Task1({ onComplete, onPrevious, taskNumber, totalTasks, participantId, micStream, screenStream, isRecording, scenario, existingData }: Task1Props) {
  ...
  useEffect(() => {
    ...
    timerRef.current = setInterval(() => {
      ...
      // Show warning after 2 minutes (120 seconds)
  ...
  const triggerNervousLaugh = () => {
    // Create a confetti effect with nervous laugh emojis
    const scalar = 2;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <RadioGroup value={completed} onValueChange={setCompleted}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="t1-yes" />
              <Label htmlFor="t1-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="t1-no" />
              <Label htmlFor="t1-no" className="flex-1">
                <span>No</span>
                {showTimeWarning && (
        ...
        {/* Open Response */}
        <div className="space-y-3">
          <Label htmlFor="t1-feedback">
            What did you think about this task? Any hesitations or confusion? *
          </Label>
          <Textarea
            id="t1-feedback"
