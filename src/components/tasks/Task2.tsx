...
export function Task2({ onComplete, onPrevious, taskNumber, totalTasks, participantId, micStream, screenStream, isRecording, scenario, existingData }: Task2Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <RadioGroup value={completed} onValueChange={setCompleted}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="t2-yes" />
              <Label htmlFor="t2-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="t2-no" />
              <Label htmlFor="t2-no" className="flex-1">
                <span>No</span>
                {showTimeWarning && (
        ...
        <div className="space-y-3">
          <h3>How easy was it to find your Vault, make a new page, and add the first three cards? *</h3>
        ...
        <div className="space-y-3">
          <Label htmlFor="t2-feedback">
            What did you think about creating a new page and organizing cards? Any confusion or suggestions? *
          </Label>
          <Textarea
            id="t2-feedback"
